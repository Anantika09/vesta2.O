...
const Register = () => {
  ...
  try {
    ...
    // CONSISTENCY: Store exactly like Login does
    localStorage.setItem('token', result.token);
    localStorage.setItem('user', JSON.stringify(result.data.user));

    setSuccess("Account created! Redirecting...");
    setTimeout(() => navigate("/"), 1500); // Redirect to Home, not Login, since they are already auth'd
  ...
  return (
    <div className="register-page">
      ...
      <div className="auth-wrapper" style={{ marginTop: '100px' }}>
        ...
        {/* Feature Sidebar - Compact Version */}
